...
package top.volusus.engine.co.bean;

import top.volusus.engine.annotation.Feature;
import top.volusus.engine.annotation.FeatureClass;
import top.volusus.engine.clz.IFeature;
 ...
 * </p>
 * <p>
 * <b>Creation:</b> Instances are created by {@link top.volusus.engine.processor.NativeFeatureProcessor}
...
public class NativeFeatureBean extends AbstractFeatureBean {
    ...
    /**
     * Custom properties defined via {@link top.volusus.engine.annotation.properties.Property} annotations.
     */
