...
## 更新摘要
**变更内容**
- 新增基于README.md的完整中文使用示例和配置说明
- 更新快速开始部分，包含完整的依赖配置、特征类定义和服务调用示例
- 新增详细的配置参数说明，包括线程池配置和超时设置
- 更新编译参数设置部分，强调-maven-compiler-plugin配置的重要性
- 增强故障排查指南，包含具体的IDE配置步骤
- 新增外部Bean集成和后处理器使用的高级示例
...
**章节来源**
- [README.md:371-389](file://README.md#L371-L389)
...
**章节来源**
- [README.md:98-151](file://README.md#L98-L151)
...
| 配置项 | 默认值 | 说明 |
|--------|--------|------|
| `featureThreadPoolSize` | CPU 核心数 × 2 | 线程池核心线程数 |
| `featureThreadPoolMaxSize` | CPU 核心数 × 2 | 线程池最大线程数 |
| `calcTimeout` | 10000 ms | 计算超时时间（毫秒） |
| `threadPoolNamePrefix` | "feature-pool-" | 线程池名称前缀 |
...
- [README.md:338-368](file://README.md#L338-L368)
...
**章节来源**
- [README.md:393-423](file://README.md#L393-L423)
