...
- 更新安装配置部分以反映 README.en.md 和 README.zh.md 中的最新要求
- 增强故障排查指南，包含编译参数相关的常见问题
- **新增**：多语言文档支持说明，包括英文文档访问方式

## 目录
1. [简介](#简介)
2. [多语言文档支持](#多语言文档支持)
3. [环境要求](#环境要求)
4. [Maven 依赖配置](#maven-依赖配置)
5. [编译参数设置](#编译参数设置)
6. [第一个特征函数](#第一个特征函数)
7. [特征计算流程详解](#特征计算流程详解)
8. [外部特征 Bean 的使用](#外部特征-bean-的使用)
9. [配置项与线程池](#配置项与线程池)
10. [依赖分析](#依赖分析)
11. [性能考虑](#性能考虑)
12. [故障排查指南](#故障排查指南)
...
## 多语言文档支持
项目提供双语文档支持，开发者可以根据需要选择合适的语言版本：

### 英文文档
- **文件名**：README.en.md
- **访问方式**：直接访问项目根目录下的 README.en.md 文件
- **适用场景**：国际开发者、英文技术文档阅读习惯

### 中文文档  
- **文件名**：README.zh.md
- **访问方式**：直接访问项目根目录下的 README.zh.md 文件
- **适用场景**：国内开发者、中文技术文档阅读习惯
...
- [README.zh.md:83-87](file://README.zh.md#L83-L87)
...
**章节来源**
- [README.en.md:88-96](file://README.en.md#L88-L96)
- [README.zh.md:88-96](file://README.zh.md#L88-L96)
...
**章节来源**
- [README.en.md:371-389](file://README.en.md#L371-L389)
- [README.zh.md:371-389](file://README.zh.md#L371-L389)
...
**章节来源**
- [README.en.md:98-151](file://README.en.md#L98-L151)
- [README.zh.md:98-151](file://README.zh.md#L98-L151)
...
- [README.zh.md:338-368](file://README.zh.md#L338-L368)
...
**章节来源**
- [README.en.md:393-423](file://README.en.md#L393-L423)
- [README.zh.md:393-423](file://README.zh.md#L393-L423)
...
### 相关文档链接
- **英文文档**：[README.en.md](file://README.en.md)
- **中文文档**：[README.zh.md](file://README.zh.md)
