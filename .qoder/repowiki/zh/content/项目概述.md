...
## 更新摘要
**变更内容**
- 新增完整的国际化支持，包含中英文双语文档
- 增强项目的国际化架构说明，涵盖多语言文档策略
- 更新技术栈描述，反映国际化文档的维护需求
- 补充国际化贡献指南和社区行为准则
- 更新项目许可证和开源协议说明
...
**图表来源**
- [README.en.md:11-21](file://README.en.md#L11-L21)

**章节来源**
- [README.en.md:11-27](file://README.en.md#L11-L27)
- [README.zh.md:11-27](file://README.zh.md#L11-L27)
...
**图表来源**
- [README.en.md:47-57](file://README.en.md#L47-L57)
...
**图表来源**
- [README.en.md:61-77](file://README.en.md#L61-L77)
...
- [FeatureEntity.java:27-214](file://src/main/java/com/github/zh/engine/co/FeatureEntity.java#L27-L214)
...
**章节来源**
- [pom.xml:52-172](file://pom.xml#L52-L172)
- [spring.factories:1-2](file://src/main/resources/META-INF/spring.factories#L1-L2)
- [FeatureProperties.java:13-52](file://src/main/java/com/github/zh/engine/properties/FeatureProperties.java#L13-L52)
...
- [README.en.md:395-423](file://README.en.md#L395-L423)

## 国际化支持

### 多语言文档策略
项目现已提供完整的国际化支持，包含中英文双语文档，确保全球开发者都能无障碍使用本项目。

#### 中文文档
- [README.zh.md](file://README.zh.md)：完整的中文使用指南，包含详细的中文说明和示例
- 适合国内用户和中文环境下的开发团队使用

#### 英文文档  
- [README.en.md](file://README.en.md)：完整的英文使用指南，覆盖所有功能特性
- 适合国际用户和海外开发者参考学习
...
### 技术栈国际化
- **JDK 8+**：保证注解参数名保留与基础并发能力
- **Spring Boot 2.x**：自动装配与条件化配置，支持国际化配置
- **Javassist**：运行时字节码生成，避免手写样板代码
- **SLF4J**：日志门面，便于集成各类日志实现

**章节来源**
- [README.en.md:31-42](file://README.en.md#L31-L42)
- [README.zh.md:31-42](file://README.zh.md#L31-L42)
- [CONTRIBUTING.md:17-21](file://CONTRIBUTING.md#L17-L21)
...
- [README.en.md:439-446](file://README.en.md#L439-L446)

## 结论
本项目通过注解驱动与运行时字节码生成，将函数声明与编排自动化，结合 DAG 与并行执行，有效解决了传统烟囱式调用中的重复与串行问题。其轻量级设计与 Spring Boot Starter 形式，使得在微服务与数据平台中快速落地成为可能。

**新增的国际化支持**进一步增强了项目的可访问性，通过中英文双语文档，为全球开发者提供了更好的使用体验。建议在复杂依赖场景下谨慎处理循环依赖，并通过配置与监控保障稳定性与性能。
...
**章节来源**
- [README.en.md:81-151](file://README.en.md#L81-L151)
- [README.zh.md:81-151](file://README.zh.md#L81-L151)
